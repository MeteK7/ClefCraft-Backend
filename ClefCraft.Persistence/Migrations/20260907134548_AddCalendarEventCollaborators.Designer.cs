...
namespace ClefCraft.Persistence.Migrations
{
    ...
    [Migration("20260907134548_AddCalendarEventCollaborators")]
    partial class AddCalendarEventCollaborators
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClefCraft.Domain.BoardItemRelation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("SourceBoardItemId")
                        .HasColumnType("integer");

                    b.Property<int>("TargetBoardItemId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SourceBoardItemId", "TargetBoardItemId", "RelationType")
                        .IsUnique();

                    b.ToTable("BoardItemRelations", (string)null);
                });
            ...
            modelBuilder.Entity("ClefCraft.Domain.BoardMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ClefCraft.Domain.BoardItemRelation", b =>
                {
                    b.HasOne("ClefCraft.Domain.BoardItem", "SourceBoardItem")
                        .WithMany("OutgoingRelations")
                        .HasForeignKey("SourceBoardItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClefCraft.Domain.BoardItem", "TargetBoardItem")
