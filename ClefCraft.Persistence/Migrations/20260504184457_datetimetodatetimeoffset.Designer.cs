...
namespace ClefCraft.Persistence.Migrations
{
    ...
    [Migration("20260504184457_datetimetodatetimeoffset")]
            ...
            modelBuilder.Entity("ClefCraft.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2026, 5, 4, 21, 44, 57, 182, DateTimeKind.Local).AddTicks(103),
                            DateModified = new DateTime(2026, 5, 4, 21, 44, 57, 182, DateTimeKind.Local).AddTicks(120),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
