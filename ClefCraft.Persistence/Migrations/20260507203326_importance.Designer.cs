...
namespace ClefCraft.Persistence.Migrations
{
    ...
    [Migration("20260507203326_importance")]
            ...
            modelBuilder.Entity("ClefCraft.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2026, 5, 7, 23, 33, 25, 267, DateTimeKind.Local).AddTicks(6679),
                            DateModified = new DateTime(2026, 5, 7, 23, 33, 25, 267, DateTimeKind.Local).AddTicks(6695),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
