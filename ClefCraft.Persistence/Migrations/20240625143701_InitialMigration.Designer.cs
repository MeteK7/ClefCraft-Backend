...
namespace ClefCraft.Persistence.Migrations
{
    ...
    [Migration("20240625143701_InitialMigration")]
            ...
            modelBuilder.Entity("ClefCraft.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 6, 25, 17, 37, 0, 631, DateTimeKind.Local).AddTicks(7987),
                            DateModified = new DateTime(2024, 6, 25, 17, 37, 0, 631, DateTimeKind.Local).AddTicks(8020),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
