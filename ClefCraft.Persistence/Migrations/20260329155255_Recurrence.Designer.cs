...
namespace ClefCraft.Persistence.Migrations
{
    ...
    [Migration("20260329155255_Recurrence")]
            ...
            modelBuilder.Entity("ClefCraft.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2026, 3, 29, 18, 52, 54, 822, DateTimeKind.Local).AddTicks(2759),
                            DateModified = new DateTime(2026, 3, 29, 18, 52, 54, 822, DateTimeKind.Local).AddTicks(2776),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
