...
namespace ClefCraft.Persistence.Migrations
{
    ...
    [Migration("20260221124824_FixAssignee")]
    partial class FixAssignee
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClefCraft.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2026, 2, 21, 15, 48, 24, 255, DateTimeKind.Local).AddTicks(3448),
                            DateModified = new DateTime(2026, 2, 21, 15, 48, 24, 255, DateTimeKind.Local).AddTicks(3464),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
