...
namespace ClefCraft.Persistence.Migrations
{
    ...
    [Migration("20250122113444_WorkHistory")]
            ...
            modelBuilder.Entity("ClefCraft.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2025, 1, 22, 14, 34, 43, 969, DateTimeKind.Local).AddTicks(3880),
                            DateModified = new DateTime(2025, 1, 22, 14, 34, 43, 969, DateTimeKind.Local).AddTicks(3903),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
