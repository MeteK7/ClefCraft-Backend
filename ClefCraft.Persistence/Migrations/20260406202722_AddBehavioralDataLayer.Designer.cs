...
namespace ClefCraft.Persistence.Migrations
{
    ...
    [Migration("20260406202722_AddBehavioralDataLayer")]
    partial class AddBehavioralDataLayer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClefCraft.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2026, 4, 6, 23, 27, 21, 396, DateTimeKind.Local).AddTicks(7661),
                            DateModified = new DateTime(2026, 4, 6, 23, 27, 21, 396, DateTimeKind.Local).AddTicks(7674),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
            ...
            modelBuilder.Entity("ClefCraft.Domain.UserInteractionSignal", b =>
                {
                    ...
                    b.ToTable("UserInteractionSignals");
                });
