...
namespace ClefCraft.Persistence.Migrations
{
    ...
    [Migration("20250112073020_CalendarEvent")]
            ...
            modelBuilder.Entity("ClefCraft.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2025, 1, 12, 10, 30, 19, 541, DateTimeKind.Local).AddTicks(9484),
                            DateModified = new DateTime(2025, 1, 12, 10, 30, 19, 541, DateTimeKind.Local).AddTicks(9499),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
