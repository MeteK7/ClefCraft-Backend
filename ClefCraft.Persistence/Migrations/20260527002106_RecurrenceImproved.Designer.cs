...
namespace ClefCraft.Persistence.Migrations
{
    ...
    [Migration("20260527002106_RecurrenceImproved")]
    partial class RecurrenceImproved
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClefCraft.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2026, 5, 27, 3, 21, 5, 713, DateTimeKind.Local).AddTicks(15),
                            DateModified = new DateTime(2026, 5, 27, 3, 21, 5, 713, DateTimeKind.Local).AddTicks(32),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
