...
namespace ClefCraft.Persistence.Migrations
{
    ...
    [Migration("20260306192854_updateDateTime")]
            ...
            modelBuilder.Entity("ClefCraft.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2026, 3, 6, 22, 28, 54, 219, DateTimeKind.Local).AddTicks(536),
                            DateModified = new DateTime(2026, 3, 6, 22, 28, 54, 219, DateTimeKind.Local).AddTicks(551),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
