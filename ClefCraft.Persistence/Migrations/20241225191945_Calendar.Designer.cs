...
namespace ClefCraft.Persistence.Migrations
{
    ...
    [Migration("20241225191945_Calendar")]
            ...
            modelBuilder.Entity("ClefCraft.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 12, 25, 22, 19, 45, 90, DateTimeKind.Local).AddTicks(1061),
                            DateModified = new DateTime(2024, 12, 25, 22, 19, 45, 90, DateTimeKind.Local).AddTicks(1076),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
