...
namespace ClefCraft.Persistence.Migrations
{
    ...
    [Migration("20240825193637_StatusIsUpdated")]
    partial class StatusIsUpdated
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClefCraft.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 8, 25, 22, 36, 37, 620, DateTimeKind.Local).AddTicks(63),
                            DateModified = new DateTime(2024, 8, 25, 22, 36, 37, 620, DateTimeKind.Local).AddTicks(78),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
