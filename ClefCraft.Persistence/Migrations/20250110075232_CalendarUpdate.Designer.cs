...
namespace ClefCraft.Persistence.Migrations
{
    ...
    [Migration("20250110075232_CalendarUpdate")]
            ...
            modelBuilder.Entity("ClefCraft.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2025, 1, 10, 10, 52, 32, 242, DateTimeKind.Local).AddTicks(5145),
                            DateModified = new DateTime(2025, 1, 10, 10, 52, 32, 242, DateTimeKind.Local).AddTicks(5163),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
