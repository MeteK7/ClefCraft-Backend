...
namespace ClefCraft.Persistence.Migrations
{
    ...
    [Migration("20240825194318_StatusIsUpdatedTest")]
    partial class StatusIsUpdatedTest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClefCraft.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 8, 25, 22, 43, 18, 247, DateTimeKind.Local).AddTicks(2021),
                            DateModified = new DateTime(2024, 8, 25, 22, 43, 18, 247, DateTimeKind.Local).AddTicks(2037),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
